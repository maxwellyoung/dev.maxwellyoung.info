...
// A distilled read of the Canon catalog (4383 works), for the
...
export const canonFeed: CanonFeed = {
  ...
  "sourceSyncedAt": "2026-09-21T00:14:06.296Z",
  "totalWorks": 4383,
  "regionCount": 22,
  "regions": [
    "Innovative Hip-Hop Fusion",
    "Eclectic Rock & Pop",
    "Visionary Sci-Fi Classics",
    "Cult Classic Thrillers"
  ],
  "now": [
    {
    ...
    {
      "id": "applemusic:teenmassacre--i-guess-i-ll-move-on-and-romance-away-single",
      "verb": "in rotation",
      "title": "I Guess i'll Move On And Romance Away",
      "creator": "teenmassacre",
      "note": "This is what I’m listening to right now.",
      "href": "https://music.apple.com/nz/search?term=I%20Guess%20i'll%20Move%20On%20And%20Romance%20Away%20-%20Single%20teenmassacre%202026",
      "art": {
