...
// A distilled read of the Canon catalog (4301 works), for the
...
export const canonFeed: CanonFeed = {
  ...
  "sourceSyncedAt": "2026-09-06T21:42:57.976Z",
  "totalWorks": 4301,
  "regionCount": 22,
  "regions": [
    "Contemporary Hip-Hop Fusion",
    "Classic Dramedy & Romance",
    "Surreal Romantic Dramas",
    "Hip-Hop & Electronic Vibes"
  ],
  "now": [
    {
    ...
    {
      "id": "applemusic:prefab-sprout--protest-songs",
      "verb": "in rotation",
      "title": "Protest Songs",
      "creator": "Prefab Sprout",
      "note": "This is what I’m listening to right now.",
      "href": "https://music.apple.com/nz/search?term=Protest%20Songs%20Prefab%20Sprout%201989",
      "art": {
