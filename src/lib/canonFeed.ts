...
// A distilled read of the Canon catalog (4281 works), for the
...
export const canonFeed: CanonFeed = {
  ...
  "sourceSyncedAt": "2026-09-03T16:30:55.998Z",
  "totalWorks": 4281,
  "regionCount": 22,
  "regions": [
    "Eclectic Indie",
    "Art House Dramas",
    "Musical Comedies & Dramas",
    "Dark Comedy & Drama"
  ],
  "now": [
    {
    ...
    {
      "id": "applemusic:smog--red-apple-falls",
      "verb": "in rotation",
      "title": "Red Apple Falls",
      "creator": "Smog",
      "note": "This is what I’m listening to right now.",
      "href": "https://music.apple.com/nz/search?term=Red%20Apple%20Falls%20Smog%201997",
      "art": {
