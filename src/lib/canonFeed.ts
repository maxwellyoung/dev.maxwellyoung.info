...
// A distilled read of the Canon catalog (4240 works), for the
...
export const canonFeed: CanonFeed = {
  ...
  "sourceSyncedAt": "2026-08-28T22:08:33.110Z",
  "totalWorks": 4240,
  "regionCount": 22,
  "regions": [
    "Alternative Rock & Soul",
    "Eclectic Hip-Hop & R&B",
    "Contemporary Dramedy & Fantasy",
    "Documentary Dramas & Thrillers"
  ],
  "now": [
    {
    ...
    {
      "id": "applemusic:ice-spice-lil-yachty--out-my-face-my-baby-single",
      "verb": "in rotation",
      "title": "Out My Face (My Baby)",
      "creator": "Ice Spice & Lil Yachty",
      "note": "This is what I’m listening to right now.",
      "href": "https://music.apple.com/nz/search?term=Out%20My%20Face%20(My%20Baby)%20-%20Single%20Ice%20Spice%20%26%20Lil%20Yachty%202026",
      "art": {
