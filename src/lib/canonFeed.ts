...
// A distilled read of the Canon catalog (4297 works), for the
...
export const canonFeed: CanonFeed = {
  ...
  "sourceSyncedAt": "2026-09-06T12:23:11.534Z",
  "totalWorks": 4297,
  "regionCount": 22,
  "regions": [
    "Modern Hip-Hop Vibes",
    "Classic European Drama",
    "Eclectic Soulful Sounds",
    "Romantic Dramedies"
  ],
  "now": [
    {
    ...
    {
      "id": "applemusic:prefab-sprout--i-trawl-the-megahertz",
      "verb": "in rotation",
      "title": "I Trawl the Megahertz",
      "creator": "Prefab Sprout",
      "note": "This is what I’m listening to right now.",
      "href": "https://music.apple.com/nz/search?term=I%20Trawl%20the%20Megahertz%20Prefab%20Sprout%202003",
      "art": {
