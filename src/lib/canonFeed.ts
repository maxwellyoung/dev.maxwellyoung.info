...
// A distilled read of the Canon catalog (4278 works), for the
...
export const canonFeed: CanonFeed = {
  ...
  "sourceSyncedAt": "2026-09-03T11:52:42.785Z",
  "totalWorks": 4278,
  "regionCount": 22,
  "regions": [
    "Contemporary Dramas & Romances",
    "Cult Crime Thrillers",
    "Classic Melodrama & Romance",
    "Golden Age Classics"
  ],
  "now": [
    {
    ...
    {
      "id": "applemusic:the-beatles--magical-mystery-tour",
      "verb": "in rotation",
      "title": "Magical Mystery Tour",
      "creator": "The Beatles",
      "note": "This is what I’m listening to right now.",
      "href": "https://music.apple.com/nz/search?term=Magical%20Mystery%20Tour%20The%20Beatles%201967",
      "art": {
