...
// A distilled read of the Canon catalog (4144 works), for the
...
export const canonFeed: CanonFeed = {
  ...
  "sourceSyncedAt": "2026-08-24T07:50:56.755Z",
  "totalWorks": 4144,
  "regionCount": 21,
  "regions": [
    "Contemporary Rock & Pop",
    "Eclectic Modern Sounds",
    "Thought-Provoking Dramedies",
    "Artful Dramas & Fantasies"
  ],
  "now": [
    {
    ...
    {
      "id": "applemusic:split-enz--mental-notes-remastered",
      "verb": "in rotation",
      "title": "Mental Notes",
      "creator": "Split Enz",
      "note": "This is what I’m listening to right now.",
      "href": "https://music.apple.com/nz/search?term=Mental%20Notes%20(Remastered)%20Split%20Enz%201975",
      "art": {
