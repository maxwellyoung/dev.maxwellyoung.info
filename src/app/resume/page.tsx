...
export default function Resume() {
  return (
    <div className="relative w-full bg-white p-6 flex flex-col items-center fade-in">
      <div className="max-w-4xl w-full">
        <div className="flex justify-between items-center mb-6">
          <div>
            <span className="block text-3xl font-bold text-black font-robotoMono">
              Maxwell Young
            </span>
            <span className="block text-xl font-normal text-black font-robotoMono">
              Software Engineer
            </span>
          </div>
          <div className="flex items-center space-x-2">
            <Link href="/MaxwellYoung_CV.pdf" legacyBehavior>
              <a
                className="flex items-center px-4 py-2 text-sm font-medium text-blue-600 bg-transparent border border-blue-600 rounded-md hover:bg-blue-600 hover:text-white transition duration-300 ease-in-out transform hover:scale-105"
                download
              >
                <svg
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            <div className="relative">
              <span className="block text-xs font-normal text-gray-500 font-inter uppercase tracking-wide mb-2">
                Experience
              </span>
            </div>
            <div className="mb-4">
              ...
              <span className="block text-sm font-normal text-black font-inter">
                Freelance
              </span>
              <span className="block text-xs font-normal text-gray-500 font-inter">
                Apr 2023 - Present, Auckland
              </span>
              <ul className="list-disc pl-5 mt-2 text-sm font-normal text-black font-inter">
                <li>
            ...
            <div className="mb-8">
              <div>
                <span className="block text-sm font-bold text-black font-inter mt-4">
          ...
          <div className="lg:col-span-1">
            <div className="mt-8 lg:mt-0">
              <div>
                <span className="block text-sm font-bold text-gray-500 font-inter">
                  Contact Information
                </span>
              </div>
              <span className="block text-sm font-normal text-gray-500 font-inter mt-2">
            ...
            <div className="mt-8">
              ...
              <span className="block text-sm font-normal text-gray-500 font-inter underline mt-2">
                maxwellyoung.info
                <br />
      ...
      <div className="absolute top-0 left-0 w-full h-1 bg-[#EA2D42]" />
    </div>
  );
}
